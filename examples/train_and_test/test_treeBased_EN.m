...
ff=@(x,y,rho1,rho2,rho3,alpha)SolveTreeBased_ElasticNet(x,y,Cluster,rho1,rho2,rho3,alpha);
...
W = SolveTreeBased_ElasticNet(X_tr, Y_tr, Cluster, best_param(1), best_param(2), best_param(3), best_param(4));
